...
<script type="text/javascript">
	...
	$(function(){
		...
		//当市场活动主页面加载完成时，查询所有数据的第一页以及所有数据的总条数,默认每页显示10条
		...
		$("#importActivityBtn").click(function (){
			//收集参数
			var activiityFileName=$("#activityFile").val();
			var suffix=activiityFileName.substr(activiityFileName.lastIndexOf(".")+1).toLocaleLowerCase();
			if (suffix!="xls"){
				alert("只支持xls文件格式");
				return;
			}
				...
				<div class="modal-body">
					...
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control mydate" name="mydate" id="edit-startTime" readonly>
							</div>
							<label for="edit-endTime" class="col-sm-2 control-label">结束日期</label>
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control mydate" name="mydate" id="edit-endTime" readonly>
							</div>
						</div>
